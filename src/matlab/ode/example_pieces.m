...
figure
%nutau flux no regeneration
[w,v,ci,energy_nodes] = cascade_noreg(-3,g);
nt_noreg=get_att_value(g,w,v,ci,energy_nodes,zenith,E');
loglog(E,att(3,:),'r',E,Areg(:,3),'g',E,nt_noreg,'b');
legend('\nu_\tau ODE','\nu_\tau nuFATE','\nu_\tau NO REG','location','southwest');
