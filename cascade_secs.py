...
def get_RHS_matrices(energy_nodes,sigma_fname,sig3fname,dxs_fname,secname,regenname):
    ...
    RHSMatrix = np.vstack((np.hstack((RHSMatrix1,RHSMatrix2)),np.hstack((RHSMatrix3,RHSMatrix4))))
